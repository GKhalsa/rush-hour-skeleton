...
class CreateClientTest < Minitest::Test
  ...
  def test_it_does_not_create_a_client_with_parameters_missing
    ...
    post '/sources', { client: {identifier: "", root_url: ""}}
    ...
    post '/sources', { client: {identifier: "Turing", root_url: nil}}

    assert_equal 0, Client.count
    assert_equal 400, last_response.status
    assert_equal "Root url can't be blank", last_response.body

    post '/sources', { client: {identifier: nil, root_url: "https://www.turing.io/"}}
